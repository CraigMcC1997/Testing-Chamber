...
namespace Testing_Chamber
{
    class Bullet : Sprite
    {
        ...
        public Bullet(ContentManager Content, WindowWidth WindowWidth, int WindowHeight)
        {
        ...
        public void ShootBullet(Gun m_Gun)
        {
            //Gives the bullet a position
            position = new Vector2
                 (m_Gun.position.X + m_Gun.Texture.Width / 2 - Texture.Width / 2, m_Gun.position.Y);
